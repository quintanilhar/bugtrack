...
<head>
  ...
  <link rel="stylesheet" href="theme/admin-lte/2.3.0/css/AdminLTE.min.css">
  <link rel="stylesheet" href="theme/admin-lte/2.3.0/css/skins/skin-blue.min.css"   >
</head>
...
<!-- ./wrapper -->
    ...
    @section('scripts')
        ...
        <script src="theme/admin-lte/2.3.0/js/app.min.js"></script>
    @show
@show
</body>
</html>
